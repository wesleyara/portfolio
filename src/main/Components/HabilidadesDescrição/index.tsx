...
import puppeteerImg from "../../Assets/Images/image-puppeteer.png";
...
export function HabilidadesSass() {
  return (
    <>
      <div id="description-hab-images" className="description-hab-images">
        <img
      ...
      <div id="image-description" className="image-description">
        ...
        <br />
        <p className="paragrafo">
          Sass é uma linguagem de folhas de estilo concebida inicialmente por
          Hampton Catlin e desenvolvida por Natalie Weizenbaum. Depois de suas
          versões iniciais, Weizenbaum e Chris Eppstein continuaram a estender
          Sass com SassScript, uma simples linguagem de script usada em arquivos
          Sass.
        </p>
      </div>
    </>
